...
/**
 * Modified from https://github.com/BenjaminHoegh/ParsedownToc
 * License: MIT (license belongs to respective owner).
 */
...
class ParsedownToc extends ParsedownExtra
{
    ...
    private $anchorDuplicates = [];
    private $contentsListArray = [];
    private $contentsListString = '';
    private $createAnchorIDCallback = null;
    private $firstHeadLevel = 0;
     ...
     * @return void
     */
    public function setTocSelectors(array $selectors)
    {
     ...
     * @return void
     */
    public function setTocDelimiter($delimiter)
    {
     ...
     * @return void
     */
    public function setTocLimit($limit)
    {
     ...
     * @return void
     */
    public function setTocLowercase($lowercase)
    {
     ...
     * @return void
     */
    public function setTocReplacements(array $replacements = [])
    {
     ...
     * @return void
     */
    public function setTocTransliterate($transliterate)
    {
     ...
     * @return void
     */
    public function setTocUrlencode($urlencode)
    {
     ...
     * @return void
     */
    public function setTocBlacklist(array $blacklist)
    {
     ...
     * @return void
     */
    public function setTocTag($toc_tag)
    {
     ...
     * @return void
     */
    public function setTocId($toc_id)
    {
    ...
    protected function blockHeader($Line)
    {
        ...
        if (!empty($Block)) {
            $text = isset($Block['element']['text'])
                ? $Block['element']['text']
                : (iseet($Block['element']['handler']['argument']) ? $Block['element']['handler']['argument'] : '');
    ...
    protected function blockSetextHeader($Line, array $Block = null)
    {
        ...
        if (!empty($Block)) {
            $text = isset($Block['element']['text'])
                ? $Block['element']['text']
                : (isset($Block['element']['handler']['argument']) ? $Block['element']['handler']['argument'] : '');
            $level = $Block['element']['name'];
            $id = isset($Block['element']['attributes']['id'])
                ? $Block['element']['attributes']['id']
                : $this->createAnchorID($text);
     ...
     */
    public function setCreateAnchorIDCallback(callable $callback)
    {
     ...
     */
    protected function sanitizeAnchor($text)
    {
     ...
     */
    protected function uniquifyAnchorID($text)
    {
     ...
     * @return string
     */
    protected function getTocIdAttribute()
    {
